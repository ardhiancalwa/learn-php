 ...
 */
 ...
 class Person {
     //attribute itu diimplementasikan sebagai variabel class
     public $name, $height, $weight;
     
     //constructor itu adalah fungsi yang pertama kali dijalankan
     //saat proses pembuatan objek baru (ada keyword "new")
     public function __constructor($name, $height, $weight){
         $this -> name = $name;
         $this -> height = $height;
         $this -> weight = $weight;
     }

     //behaviour itu dimplementasikan sebagai method atau fungsi
 ...
 echo "BMI dari person 2 adalah ".$person2 -> countBMI();
 echo "dengan kategori ".$person2 -> getCategory();

 echo nl2br("\n"); // nl2br itu digunakan untuk apply break line

 $person3 = new Person("Khali", 2.1, 120);
 echo "BMI dari person 3 adalah ".$person3 -> countBMI();
